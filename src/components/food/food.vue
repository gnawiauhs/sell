    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="content">
          ...
          <div class="price">
            <span class="now"><span class="yuan">￥</span>{{food.price}}</span>
          ...
          <transition name="fade">
            <div @click.stop.prevent="addFirst" @add="addFood" class="buy" v-show="!food.count || food.count===0">加入购物车</div>
          </transition>
        </div>
